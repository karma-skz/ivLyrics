...
window.LANG_AR = {
  ...
  "sections": {
    ...
    "desktopOverlay": "طبقة سطح المكتب",
    "desktopOverlaySubtitle": "عرض الكلمات كطبقة على سطح المكتب"
  },
  "overlay": {
    "enabled": {
    ...
    "downloadDesc": "قم بالتنزيل إذا لم يكن تطبيق الطبقة مثبتًا"
  },
  "settings": {
    "language": {
      "label": "اللغة",
    ...
    "videoHelper": {
      ...
      "desc": "قم بتنزيل وتشغيل مقاطع فيديو YouTube محلياً. شاهد الفيديوهات بدون تسجيل الدخول.",
      "info": "💡 مقاطع فيديو YouTube لا يتم تحميلها؟\n\nتقيد Google بعض المستخدمين من تشغيل مقاطع فيديو YouTube بدون تسجيل الدخول.\nاستخدام البرنامج المساعد يسمح بتحميل الفيديوهات بشكل صحيح.",
      "download": "تنزيل المساعد",
      "checkConnection": "التحقق من الاتصال",
      "connected": "متصل بالبرنامج المساعد",
      "disconnected": "لا يمكن الاتصال بالبرنامج المساعد",
      "status": {
        "connected": "متصل",
        "disconnected": "غير متصل",
  ...
  "fullscreen": {
    ...
    "queue": {
      ...
      "noRecent": "لا توجد عمليات تشغيل أخيرة"
    },
    "contextType": {
  ...
  "settingsAdvanced": {
    ...
    "fullscreenMode": {
      ...
      "toggleTvModeKey": {
        "desc": "اختصار تبديل وضع التلفزيون",
        "info": "يعمل فقط في وضع ملء الشاشة. للتبديل بين وضع التلفزيون والوضع العادي"
      },
      "tvMode": {
        "desc": "وضع التلفزيون",
      ...
      "translateMetadata": {
        ...
        "info": "ترجمة عناوين الأغاني الأجنبية وأسماء الفنانين (يتطلب مفتاح API من Gemini)"
      },
      "translateMetadataMode": {
        "desc": "وضع العرض",
        "info": "اختر كيفية عرض العنوان والفنان",
        "options": {
          "translated": "الترجمة فقط",
          "romanized": "النطق فقط",
    ...
    "normalMode": {
      ...
      "subtitle": "تكوين تخطيط وضع ملء الشاشة العادي (عندما يكون وضع التلفزيون معطلاً)",
      "showAlbumName": {
        "desc": "إظهار اسم الألبوم",
        "info": "عرض اسم الألبوم أسفل العنوان والفنان",
      },
    },
    "tvMode": {
      "title": "إعدادات وضع التلفزيون",
      "subtitle": "تكوين خيارات العرض لوضع التلفزيون",
      "showAlbumName": {
        "desc": "إظهار اسم الألبوم",
        "info": "عرض اسم الألبوم أسفل الفنان في وضع التلفزيون",
      },
      "showControls": {
        "desc": "إظهار أزرار التحكم",
        "info": "عرض أزرار التشغيل/الإيقاف، المسار السابق/التالي في وضع التلفزيون",
      },
      "showProgress": {
        "desc": "إظهار شريط التقدم",
        "info": "عرض تقدم التشغيل والوقت في وضع التلفزيون",
      },
    },
    "metadataDisplay": {
      "title": "عرض العنوان/الفنان",
      "subtitle": "تكوين كيفية عرض العنوان والفنان",
    },
    "fullscreenStyle": {
    ...
    "fullscreenUI": {
      ...
      "showQueue": {
        "desc": "إظهار لوحة قائمة الانتظار",
        "info": "عرض قائمة التشغيل عند تمرير الماوس على الجانب الأيمن من الشاشة"
      }
    },
    "controllerStyle": {
